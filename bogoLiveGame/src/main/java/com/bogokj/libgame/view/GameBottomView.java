...
import com.bogokj.libgame.adapter.GameBetCoinsOptionAdapter;
...
public class GameBottomView extends BaseGameView implements View.OnClickListener {
    ...
    private ImageView iv_bot_coins;
    private TextView tv_coins; //用户游戏币
    protected SDRecyclerView rv_coins;

    private ImageView iv_auto_start_mode;
    private View iv_game_log;
    private View iv_game_close;

    protected GameBetCoinsOptionAdapter mAdapter;
    ...
    private void init() {
        ...
        rv_coins.addDividerVertical(new SDDrawable().color(Color.TRANSPARENT).size(SDViewUtil.dp2px(5)));
    }
    ...
    protected void initView() {
        ...
        iv_game_close = findViewById(R.id.iv_game_close);
    }
    ...
    protected void initListener() {
        ...
        iv_game_close.setOnClickListener(this);
    }
     ...
     * @param canCloseGame
     */
    public void setCanCloseGame(boolean canCloseGame) {
        SDViewUtil.setVisibleOrGone(iv_game_close, canCloseGame);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (v == iv_game_close) {
            mCallback.onClickGameClose(v);
        }
    }
    ...
    public interface GameBottomViewCallback {
         ...
         * 点击关闭游戏
         */
        void onClickGameClose(View view);
    }
}
