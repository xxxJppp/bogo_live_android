...
import com.bogokj.libgame.dice.constant.DiceConstant;
...
public class DicePanelBodyView extends BaseGameView
{
    ...
    private void initDicePanel(Context context)
    {
        ...
        getScoreBoardBig().setOnClickListener(new OnClickListener()
        {
            @Override
        ...
        getScoreBoardMiddle().setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        getScoreBoardSmall().setOnClickListener(new OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
