...
public class PokerGameView extends BaseGameView implements
    ...
    private void initGameBottomView() {
        view_poker_bottom.setCallback(new GameBottomView.GameBottomViewCallback() {
            ...
            public void onClickGameClose(View view) {
                mCallback.onClickGameClose(view);
            }
        ...
        if (anim) {
            ...
            if (!getManager().isCreater()) {
                ...
                if (openGameId==0){
                    ...
                    view_poker_toast.setImageTextResId(R.drawable.ic_poker_text_xzxyqy_niu);
                }
    ...
    public void onStartShowResult(boolean sequentially) {
        if (sequentially) {
            ...
            if (openGameId==0){
                ...
                view_poker_toast.setImageTextResId(R.drawable.ic_poker_text_bpks_niu);
            }
    ...
    @Override
    public void onCanCloseGameChanged(boolean canCloseGame) {
        view_poker_bottom.setCanCloseGame(canCloseGame);
    }
