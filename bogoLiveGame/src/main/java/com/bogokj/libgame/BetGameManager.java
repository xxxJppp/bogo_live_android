...
public abstract class BetGameManager extends BaseGameManager
{
    ...
    {
        LogUtil.i("setCanCloseGame:" + canCloseGame);
        mCanCloseGame = canCloseGame;
        getBetGameManagerCallback().onCanCloseGameChanged(canCloseGame);
    }
    ...
    public interface BetGameManagerCallback extends BaseGameManagerCallback
    {
         ...
         * @param canCloseGame
         */
        void onCanCloseGameChanged(boolean canCloseGame);
