...
public class GameBankerListAdapter extends SDSimpleAdapter<GameBankerModel>
{
    ...
    public void bindData(int position, View convertView, ViewGroup parent, GameBankerModel model)
    {
        ...
        if (model.isSelected())
        {
            ...
            tv_banker_nickname.setTextColor(SDResourcesUtil.getColor(R.color.res_main_color));
            tv_coins.setTextColor(SDResourcesUtil.getColor(R.color.res_main_color));
        } else
        {
            iv_check.setSelected(false);
            tv_banker_nickname.setTextColor(SDResourcesUtil.getColor(R.color.res_text_gray_m));
            tv_coins.setTextColor(SDResourcesUtil.getColor(R.color.res_text_gray_m));
        }
