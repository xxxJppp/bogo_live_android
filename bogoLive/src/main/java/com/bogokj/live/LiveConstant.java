...
import com.bogokj.library.utils.SDBase64;
...
import com.bogokj.live.model.custommsg.CustomMsgCreaterQuit;
...
import com.bogokj.live.model.custommsg.CustomMsgLiveStopped;
...
import com.bogokj.live.model.custommsg.ICustomMsg;
...
public class LiveConstant {
    ...
    public static final class CustomMsgType {
         ...
         * 结束PK
         */
        public static final int MSG_STOP_PK = 58;
        ...
        //PK周期结束
        public static final int MSG_END_PK = 61;


        //更新PK收益
        public static final int MSG_UPDATE_PK_TICKET = 70;
        ...
        //幸运礼物中奖消息
        public static final int MSG_LUCK_GIFT = 88;

        //系统全站消息
        public static final int MSG_All_STATION = 82;

        //心愿单消息
        public static final int MSG_REFRESH_WISH = 71;
    }
    ...
    static {
        ...
        mapCustomMsgClass.put(CustomMsgType.MSG_REQUEST_PK, CustomMsgRequestPK.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_ACCEPT_PK, CustomMsgAcceptPK.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_REJECT_PK, CustomMsgRejectPK.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_START_PK, CustomMsgStartPK.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_UPDATE_PK_TICKET, CustomMsgUpdateTicketPK.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_CANCEL_PK, CustomMsgCancelPK.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_END_PK, CustomMsgEndPK.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_BUY_GUARDIAN_SUCCESS, CustomMsgBuyGuardianSuccess.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_OPEN_GUARD_SUCCESS, CustomMsgOpenGuardSuccess.class);
        mapCustomMsgClass.put(CustomMsgType.MSG_LUCK_GIFT, CustomMsgLuckGift.class);

        mapCustomMsgClass.put(CustomMsgType.MSG_REFRESH_WISH, CustomMsgRefreshWish.class);
    }
    ...
    public static final class LiveMsgType {
         ...
         * 守护者购买成功推送
         */
        public static final int MSG_BUY_GUARDIAN_SUCCESS = MSG_SHOP_GOODS_BUY_SUCCESS + 1;

        /**
         * 守护者购买成功推送
         */
        public static final int MSG_OPEN_GUARD_SUCCESS = MSG_BUY_GUARDIAN_SUCCESS + 1;

        /**
         * 守护者加入
         */
        public static final int MSG_GUARD_VIEWER_JOIN = MSG_OPEN_GUARD_SUCCESS + 1;

        /**
         * 幸运礼物中奖消息
         */
        public static final int MSG_LUCK_GIFT = MSG_GUARD_VIEWER_JOIN + 1;
