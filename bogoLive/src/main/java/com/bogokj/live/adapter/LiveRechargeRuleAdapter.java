...
public class LiveRechargeRuleAdapter extends SDSimpleAdapter<RuleItemModel>
{
    ...
    private void bindRuleData(View convertView, final RuleItemModel model)
    {
        ...
        final TextView tv_diamonds = ViewHolder.get(R.id.tv_diamonds, convertView);
        ...
        SDViewBinder.setTextView(tv_diamonds, model.getDiamonds() + AppRuntimeWorker.getDiamondName());
