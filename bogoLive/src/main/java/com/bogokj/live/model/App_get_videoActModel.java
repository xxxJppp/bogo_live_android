...
public class App_get_videoActModel extends BaseActModel
{
    ...
    private int is_vip; //0:不是VIP 1：VIP
    private String noble_car_url; //座驾动画地址
    private App_viewerActModel viewer;

    private int open_daily_task;//每日任务是否显示
    private int  guardian;//1是守护；2不是守护
    private String guardian_num;

    public String getGuardian_num() {
        return guardian_num;
    }

    public void setGuardian_num(String guardian_num) {
