...
import com.bogokj.live.LiveConstant.LiveMsgType;
...
public abstract class MsgModel {
    ...
    public CustomMsgRefreshWish getCustomMsgRefreshWish() {
        return getCustomMsgReal();
    }
...
//                        setLiveMsgType(LiveConstant.LiveMsgType.MSG_GUARD_VIEWER_JOIN);
//                    }else {
                    // 直播间消息列表类型
                ...
                case CustomMsgType.MSG_SHOP_GOODS_BUY_SUCCESS:
                    ...
                    break;
                case CustomMsgType.MSG_BUY_GUARDIAN_SUCCESS:
                    // 直播间消息列表类型
                    setLiveMsgType(LiveConstant.LiveMsgType.MSG_BUY_GUARDIAN_SUCCESS);
                    break;
                case CustomMsgType.MSG_OPEN_GUARD_SUCCESS:
                    // 直播间消息列表类型
                    setLiveMsgType(LiveConstant.LiveMsgType.MSG_OPEN_GUARD_SUCCESS);
                    break;

                case CustomMsgType.MSG_LUCK_GIFT:
                    // 直播间幸运礼物消息
                    setLiveMsgType(LiveConstant.LiveMsgType.MSG_LUCK_GIFT);
                    break;
                default:
                    break;
            }
