...
import com.bogokj.games.model.App_banker_applyActModel;
import com.bogokj.games.model.App_banker_listActModel;
import com.bogokj.games.model.App_getGamesActModel;
...
import com.bogokj.hybrid.http.AppRequestCallbackWrapper;
...
import static com.bogokj.live.common.AppRuntimeWorker.getLoginUserID;
...
public class CommonInterface {
    ...
    public static SDRequestHandler requestRoomInfo(int room_id, int is_vod, String private_key, AppRequestCallback<App_get_videoActModel> listener) {
        ...
        Log.e("dealRequestRoomInfo", "发射请求");
        return AppHttpUtil.getInstance().post(params, listener);
    }
    ...
    //开通守护
    public static void openGuard(String host_id, String guardid, AppRequestCallback<BaseActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("guardians_old");
        params.putAct("guardian_buy");
        params.put("host_id", host_id);
        params.put("id", guardid);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestDoLogin(String mobile, String verify_coder, String inviteCode, String channel, AppRequestCallback<App_do_loginActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("login");
     ...
     * @param listener
     */
    public static void requestWxLogin(String openid, String access_token,String inviteCode, String channel, AppRequestCallback<App_do_updateActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("login");
     ...
     * @param listener
     */
    public static void requestQqLogin(String openid, String access_token,String inviteCode, String channel, AppRequestCallback<App_do_updateActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("login");
     ...
     * @param listener
     */
    public static void requestSinaLogin(String access_token, String uid, String inviteCode, String channel,AppRequestCallback<App_do_updateActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("login");
    ...
    public static void requestGetPKEmceeList(AppRequestCallback<App_pk_get_emcee_listActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("get_emcee_list");
        AppHttpUtil.getInstance().post(params, listener);
    }

    //获取pk时间列表
    public static void requestGetPKTimeList(AppRequestCallback<App_pk_getTime_Model> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("pk_list");
        AppHttpUtil.getInstance().post(params, listener);
    }

    public static void requestGetPKInfo(String pk_id, AppRequestCallback<App_request_get_pk_infoActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("request_get_pk_info2");
        params.put("pk_id", pk_id);
        AppHttpUtil.getInstance().post(params, listener);
    }


    public static void requestPK(String user_id, String time_id, AppRequestCallback<App_request_pkActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("request_pk");
        params.put("pk_emcee_id", user_id);
        params.put("pk_list_id", time_id);
        AppHttpUtil.getInstance().post(params, listener);
    }

    public static void requestAcceptRequestPK(String user_id, String pkid, AppRequestCallback<App_request_start_pkActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("request_accept_pk");
        params.put("pk_emcee_id", user_id);
    ...
    //拒绝pk
    public static void refusePK(AppRequestCallback<App_request_start_pkActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("request_refused_pk");
        AppHttpUtil.getInstance().post(params, listener);
    }

    public static void requestCheckIsFullInviteCode(AppRequestCallback<App_request_check_is_full_invite_codeModel> listener) {

        AppRequestParams params = new AppRequestParams();
        params.putCtl("login");
        params.putAct("is_invitation");
        AppHttpUtil.getInstance().post(params, listener);
    }

    public static void requestFullInviteCode(String inviteCode, AppRequestCallback<App_request_full_invite_codeModel> listener) {

        AppRequestParams params = new AppRequestParams();
        params.putCtl("login");
        params.putAct("invitation");
        params.put("invitation_id", inviteCode);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestGuardian(String host_id, AppRequestCallback<App_GuardianActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("guardian_old");
        params.putAct("index");
        params.put("host_id", host_id);
    ...
    public static void requestPayGuardian(String host_id, AppRequestCallback<App_PayGuardianActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("guardian_old");
        params.putAct("pay");
        params.put("host_id", host_id);
        params.put("user_id", AppRuntimeWorker.getLoginUserID());

        AppHttpUtil.getInstance().post(params, listener);
    }

    //获取守护列表
    public static void requestGuardTableList(String host_id, AppRequestCallback<GuardTableListModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("guardians_old");
        params.putAct("index");
        params.put("host_id", host_id);
    ...
    //获取守护类型
    public static void requestGuardType(String host_id, AppRequestCallback<App_duardian_index_Model> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("guardians_old");
        params.putAct("duardian_index");
        params.put("host_id", host_id);
        AppHttpUtil.getInstance().post(params, listener);
    }

    //结束pk
    public static void requestEndLivePk(AppRequestCallback<String> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("request_end_pk");
        AppHttpUtil.getInstance().post(params, listener);
    }


    //开始惩罚时间
    public static void requestStartPunishmentData(String pkId, AppRequestCallback<PkResultData> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("punishment_time_user");
        params.put("pk_id", pkId);
        AppHttpUtil.getInstance().post(params, listener);
    }

    //发布动态
    public static void doRequestPushDynamic(int type, String content, String media, int media_attr, String cover_url, String topicId, String city, AppRequestCallback<BaseActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("release");
        params.put("content", content);
        params.put("media", media);
        params.put("media_attr", media_attr);
        params.put("type", type);
        params.put("cover_url", cover_url);
        params.put("theme", topicId);
     ...
     * @param listener
     */
    public static void requestDynamicList(int p, AppRequestCallback<App_DynamicListModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("index");
        params.put("p", p);
     ...
     * @param listener
     */
    public static void requestAttentionDynamicList(int p, AppRequestCallback<App_DynamicListModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("follow_index");
        params.put("p", p);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestMyDynamicList(int p, AppRequestCallback<App_DynamicListModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("my_index");
        params.put("p", p);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestDelDynamic(String dynamic_id, AppRequestCallback<BaseActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("del_dynamic");
     ...
     * @param listener
     */
    public static void requestShareDynamic(String dynamic_id, AppRequestCallback<BaseActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("dynamic_forwarding");
        params.put("dynamic_id", dynamic_id);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * 点赞动态接口
     *
     * @param is_praise //1点赞2取消
     */
    public static void requestLikeDynamic(String dynamic_id, int is_praise, AppRequestCallback<DynamicLikeModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("praise");
        params.put("dynamic_id", dynamic_id);
     ...
     * 获取动态内容接口
     */
    public static void requestDynamicInfo(String dynamic_id, AppRequestCallback<DynamicInfoModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("get_dynamic_info");
        params.put("dynamic_id", dynamic_id);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * 获取评论接口
     */
    public static void requestDynamicCommentList(String dynamic_id, int p, AppRequestCallback<DynamicCommentListModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("get_comments");
        params.put("p", p);
        params.put("dynamic_id", dynamic_id);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * -进行评论接口
     */
    public static void requestSendComment(String dynamic_id, String content, AppRequestCallback<BaseActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("set_comments");
        params.put("dynamic_id", dynamic_id);
        params.put("content", content);
        AppHttpUtil.getInstance().post(params, listener);
    }
    ...
    //取消PK接口
    public static void requestCanclePKRequest(AppRequestCallback<App_requestCancelPKRequest> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("pk_tencent");
        params.putAct("cancel_pk_request");
        AppHttpUtil.getInstance().post(params, listener);
    }


    //获取是否关注用户接口
    public static void requestIsUserFollow(String to_user_id, AppRequestCallback<Is_user_followActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("svideo");
        params.putAct("is_follwing_userid");
        params.put("to_user_id", to_user_id);
        AppHttpUtil.getInstance().post(params, listener);
    }

    //获取话题列表
    public static void requestGetTopicList(int page, int all, String word, AppRequestCallback<BogoDynamicTopicListApi> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("dynamic_theme");
        params.put("p", page + "");
        params.put("all", all + "");
    ...
    //获取关注页面推荐列表
    public static void requestGetFollowRecommendList(AppRequestCallback<BogoFollowRecommendModelApi> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("index");
        params.putAct("recomme_user");
        AppHttpUtil.getInstance().post(params, listener);
    }

    //获取视频标签分类
    public static void requestGetVideoClassList(AppRequestCallback<BogoVideoClassLabelModelApi> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("dynamic_cate");
        AppHttpUtil.getInstance().post(params, listener);
    }

    //签到列表
    public static void requestGetDayList(AppRequestCallback<BogoDaySignListApiModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("index");
    ...
    //点击签到
    public static void requestDaySign(AppRequestCallback<BogoDaySignApiModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("index");
        params.putAct("user_signin");
        AppHttpUtil.getInstance().post(params, listener);
    }

    //获取心愿礼物列表
    public static void requestGetWishGiftList(AppRequestCallback<BogoGetWishListGiftListApiModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("user_wish");
        params.putAct("gift_list");
        AppHttpUtil.getInstance().post(params, listener);
    }

    //获取心愿列表
    public static void requestGetWishList(AppRequestCallback<BogoWishListApiModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("user_wish");
        params.putAct("wish_list");
        AppHttpUtil.getInstance().post(params, listener);
    }

    //发布心愿
    public static void requestPushWishList(String g_id, String g_num, String txt, AppRequestCallback<BogoWishListPushApiModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("user_wish");
        params.putAct("pub_wish");
    ...
    //获取音效列表
    public static void requestLiveSoundList(AppRequestCallback<BogoLiveSoundApiModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("index");
        params.putAct("home_sound");
        AppHttpUtil.getInstance().post(params, listener);
    }

    //检查今日是否需要亲到
    public static void requestCheckDayIsSign(AppRequestCallback<BogoDayIsSignApiModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("index");
        params.putAct("is_signin");
        AppHttpUtil.getInstance().post(params, listener);
    }

    //删除心愿
    public static void requestDelWish(String id, AppRequestCallback<BogoDelWishApiModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("user_wish");
        params.putAct("del_wish");
        params.put("id", id);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestNearByDynamic(int page, String listType, AppRequestCallback<App_DynamicListModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("index");
        params.put("p", page);
        params.put("list_type", listType);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestPeopleNearBy(int page, AppRequestCallback<BogoPeopleNearByModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("fujin_user");
        params.put("p", page);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void requestTopPicHistory(AppRequestCallback<BogoSearchModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("theme_log");
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void deleteTopPicHistory(AppRequestCallback<BogoSearchModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("del_theme_log");
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void searchTopicList(String word, AppRequestCallback<BogoDynamicTopicListApi> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("theme_search");
        params.put("key_word", word);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void getTodayWishList(AppRequestCallback<BogoWishLisDetailtModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("user_wish");
        params.putAct("wish_list");
        AppHttpUtil.getInstance().post(params, listener);
     ...
     * @param listener
     */
    public static void followAllUser(String ids, AppRequestCallback<BaseActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("user");
        params.putAct("follow_all");
     ...
     * @param listener
     */
    public static void getNobleList(String roomId, AppRequestCallback<NobleListModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("video");
        params.putAct("get_noble_list_old");
     ...
     * @param listener
     */
    public static void requestToppicList(int p, String themeId, AppRequestCallback<App_DynamicListModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("dynamic");
        params.putAct("index");
        params.put("p", p);
     ...
     * @param listener
     */
    public static void liveFinishUserData(String roomId, AppRequestCallback<LiveFinishUserActModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("video");
        params.putAct("user_consumption_sum");
        params.put("room_id", roomId);
        AppHttpUtil.getInstance().post(params, listener);
    }
     ...
     * @param listener
     */
    public static void getSystemMsgData(int p, AppRequestCallback<BogoSystemMsgModel> listener) {
        AppRequestParams params = new AppRequestParams();
        params.putCtl("index");
        params.putAct("msg_list");
        params.put("p", p);
        AppHttpUtil.getInstance().post(params, listener);
    }
}
