...
import com.bogokj.library.customview.SDGridLinearLayout.ItemClickListener;
...
import com.bogokj.live.adapter.LiveUserHomeRightAdapter;
import com.bogokj.live.common.AppRuntimeWorker;
import com.bogokj.live.common.CommonInterface;
import com.bogokj.live.model.App_user_reviewActModel;
...
import com.bogokj.live.view.TabLeftImage;
...
public class LiveUserHomeRightFragment extends LiveUserHomeBaseFragment
{
    ...
    private void addSortTab()
    {
        ...
        left_tab_sort0.getViewConfig(left_tab_sort0.mTvTitle).setTextColorNormalResId(R.color.res_text_gray_m).setTextColorSelectedResId(R.color.res_main_color).setTextSizeNormal(textSizeNormal).setTextSizeSelected(textSizeSelected);
        ...
        left_tab_sort1.getViewConfig(left_tab_sort1.mTvTitle).setTextColorNormalResId(R.color.res_text_gray_m).setTextColorSelectedResId(R.color.res_main_color).setTextSizeNormal(textSizeNormal).setTextSizeSelected(textSizeSelected);
    ...
    private void bindAdapter()
    {
        ...
        adapter = new LiveUserHomeRightAdapter(listModel, getActivity());
        ...
        CommonInterface.requestUser_review(page, sort, to_user_id, new AppRequestCallback<App_user_reviewActModel>()
        {
            ...
            protected void onSuccess(SDResponse resp)
            {
                if (actModel.getStatus() == 1)
                {
                    ...
                    {
                        SDViewUtil.setVisible(view_no_jilu);
                    ...
                    } else
                    {
                        ...
                        SDViewUtil.setGone(view_no_jilu);
                    }
