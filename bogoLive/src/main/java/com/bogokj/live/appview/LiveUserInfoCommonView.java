...
import com.bogokj.live.activity.LiveUserHomeReplayActivity;
...
public class LiveUserInfoCommonView extends BaseAppView {
    ...
    private void initView() {
        ...
        ll_back_layout = (LinearLayout) findViewById(R.id.ll_back_layout);
    ...
    private void initListener() {
        ...
        find(R.id.home_me_sign_in_rl).setOnClickListener(v -> getActivity().startActivity(new Intent(getActivity(), BogoSignInActivity.class)));
    }
