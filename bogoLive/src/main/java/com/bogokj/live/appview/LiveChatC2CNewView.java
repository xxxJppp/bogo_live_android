...
import com.bogokj.auction.appview.AuctionTradeMsgView;
...
public class LiveChatC2CNewView extends BaseAppView {
    ...
    //@ViewInject(R.id.rl_auction_group)
    //private RelativeLayout rl_auction_group;//群组
...
//    private SDTabUnderline tab_group;
    ...
    //private LinearLayout ll_group;//未关注content
...
//        tab_group.setTextTitle("群组");
//        tab_group.getViewConfig(tab_group.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT).setBackgroundColorSelected(SDResourcesUtil.getColor(R.color.res_main_color));
//        tab_group.getViewConfig(tab_group.mTvTitle).setTextColorNormalResId(R.color.res_text_title_bar).setTextColorSelectedResId(R.color.res_main_color);
    ...
    private void addContentView() {
        ...
        //GroupMsgView groupMsgView = new GroupMsgView(getActivity());
        //ll_group.addView(groupMsgView, lp);
