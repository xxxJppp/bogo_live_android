...
import com.bogokj.live.model.App_pop_msgActModel;
...
//       sb_pop = find(R.id.sb_pop);
        checkBox = find(R.id.input_checkbox);
...
//        });
    ...
    protected void sendMessage() {
        if (mIsPopMsg) {
            ...
            msg.getSender().setIs_guardian(LiveInformation.getInstance().getRoomInfo().getIs_guardian());
