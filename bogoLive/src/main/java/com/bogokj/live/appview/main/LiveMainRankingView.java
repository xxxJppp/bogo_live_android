...
import com.bogokj.live.appview.H5AppViewWeb;
import com.bogokj.live.appview.ranking.LiveRankingContributionView;
import com.bogokj.live.appview.ranking.LiveRankingMeritsView;
...
public class LiveMainRankingView extends BaseAppView
{
    ...
    private LiveTabUnderline tab_rank_week;
...
//                    h5AppViewWeb.loadWebViewUrl(AppRuntimeWorker.getWeekGiftUrl());
//                    view = h5AppViewWeb;
//                    break;
...
//        changeLiveTabUnderline(tab_rank_week, "周星榜");

//        LiveTabUnderline[] items = new LiveTabUnderline[]{tab_rank_merits, tab_rank_contribution,tab_rank_week};
        LiveTabUnderline[] items = new LiveTabUnderline[]{tab_rank_contribution, tab_rank_merits};
