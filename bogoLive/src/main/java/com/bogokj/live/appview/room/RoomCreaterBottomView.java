...
public class RoomCreaterBottomView extends RoomBottomView implements
    ...
    private RoomMenuView menu_wish_list;
    ...
    private RoomMenuView menu_pk;//PK
    ...
    protected void onBaseInit() {
        ...
        menu_wish_list = find(R.id.menu_wish_list);
        ...
        //心愿单
        menu_wish_list.setImageResId(R.drawable.ic_live_wish);
        //pk
        menu_pk.setImageResId(R.drawable.icon_pk);
        //判断是否显示Pk按钮
        if (AppRuntimeWorker.getIs_pk() == 0) {
            menu_pk.setVisibility(GONE);
        } else {
            menu_pk.setVisibility(VISIBLE);
        }
        ...
        menu_pk.setOnClickListener(this);
        menu_wish_list.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        if (clickListener != null) {
            if (v == menu_send_msg) {
                ...
                clickListener.onClickMenuPK(v);
            } else if (v == menu_wish_list) {
                clickListener.onClickMenuWish(v);
            }
    ...
    public interface ClickListener {
        ...
        void onClickMenuPK(View v);

        void onClickMenuWish(View v);
    }
}
