...
{
    private LiveRecordView view_record_gesture;
    ...
    public void setRecordViewListener(LiveRecordView.RecordViewListener recordViewListener)
    {
     ...
     * 触摸监听
     */
    private LiveRecordView.RecordViewListener defaultRecordViewListener = new LiveRecordView.RecordViewListener()
    {
        @Override
