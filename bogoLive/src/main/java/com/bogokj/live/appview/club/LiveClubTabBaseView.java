...
public abstract class LiveClubTabBaseView extends BaseAppView
{
    ...
    {
        Glide.with(App.getApplication()).load(model.getSociety_image())
                .apply(bitmapTransform(new BlurTransformation(25)) .placeholder(R.drawable.bg_image_loading) .error(R.drawable.bg_image_loading).dontAnimate())
                .into(iv_head_bg);
