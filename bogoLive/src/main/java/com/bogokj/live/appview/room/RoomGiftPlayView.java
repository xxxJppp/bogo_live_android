...
import com.bogokj.live.appview.ILiveGiftView;
import com.bogokj.live.model.custommsg.CustomMsgGift;
import com.bogokj.live.model.custommsg.ILiveGiftMsg;
import com.bogokj.live.model.custommsg.MsgModel;
import com.bogokj.live.view.LiveGiftPlayView;
...
public class RoomGiftPlayView extends RoomView {
    ...
    public void addMsg(ILiveGiftMsg newMsg) {
        if (newMsg != null) {
            if (!newMsg.canPlay()) {
                return;
            }
