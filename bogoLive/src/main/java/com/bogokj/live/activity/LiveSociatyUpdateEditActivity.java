...
public class LiveSociatyUpdateEditActivity extends BaseTitleActivity
{
    ...
    private void initView()
    {
        ...
        intoType = getIntent().getIntExtra(EXTRA_INTO, 0);
        ...
        if (update.equals(EXTRA_UPDATE_DATA))
        {
            ...
            if (TextUtils.isEmpty(sociaty_nick)) {
                ll_fam_nick.setVisibility(View.GONE);
            } else {
                ll_fam_nick.setVisibility(View.VISIBLE);
            }
            if (TextUtils.isEmpty(sociaty_num)) {
                ll_fam_num.setVisibility(View.GONE);
            } else {
