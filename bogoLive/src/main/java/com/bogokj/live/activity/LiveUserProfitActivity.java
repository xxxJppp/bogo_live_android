...
import com.bogokj.library.utils.UrlLinkBuilder;
...
import com.bogokj.live.model.App_profitActModel;
...
public class LiveUserProfitActivity extends BaseTitleActivity implements ISDDialogConfirm.Callback
{
    ...
    private ImageView tv_do_exchange;//兑换
    @ViewInject(R.id.tv_take_reward_wx)
    private ImageView tv_take_reward_wx;//微信提现
    @ViewInject(R.id.tv_take_reward_alipay)
    private ImageView tv_take_reward_alipay;//支付宝提现
