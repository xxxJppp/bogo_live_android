...
import com.bogokj.live.appview.ranking.LiveRankingBaseView;
...
import com.bogokj.live.event.EFinishAdImg;
...
public class LiveRankingActivity extends BaseActivity {
    ...
    private void changeLiveTabUnderline(LiveTabUnderline tabUnderline, String title) {
        ...
        tabUnderline.configTextViewTitle().setTextSizeNormal(SDResourcesUtil.getDimensionPixelSize(R.dimen.base_textsize_16)).setTextSizeSelected(SDResourcesUtil.getDimensionPixelSize(R.dimen.base_textsize_19));
