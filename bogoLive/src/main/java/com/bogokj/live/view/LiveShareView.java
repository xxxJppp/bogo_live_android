...
public class LiveShareView extends SDAppView
{
            ...
            public void bindData(int position, View convertView, ViewGroup parent, final PlatformModel model)
            {
                ...
                ll_share.setOnClickListener(new OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        {
                            case UmengSocialManager.PLATFORM_WX:
                                onClickWx(v);
                                break;
                            case UmengSocialManager.PLATFORM_WX_CIRCLE:
                                onClickWxCircle(v);
                                break;
                            case UmengSocialManager.PLATFORM_QQ:
                                onClickQQ(v);
                                break;
                            case UmengSocialManager.PLATFORM_QZONE:
                                onClickQzone(v);
                                break;
                            case UmengSocialManager.PLATFORM_SINA:
                                onClickSina(v);
                                break;
                            default:
                                break;
    ...
    private void addWeixin()
    {
        ...
        {
            PlatformModel model = new PlatformModel(UmengSocialManager.PLATFORM_WX, "微信", R.drawable.umeng_socialize_wechat);
    ...
    private void addWeixinCircle()
    {
        if (UmengSocialManager.isWeixinEnable())
        {
            PlatformModel model = new PlatformModel(UmengSocialManager.PLATFORM_WX_CIRCLE, "微信朋友圈", R.drawable.umeng_socialize_wxcircle);
            listPlatform.add(model);
        }
    }
    ...
    private void addQQ()
    {
        ...
        {
            PlatformModel model = new PlatformModel(UmengSocialManager.PLATFORM_QQ, "QQ", R.drawable.umeng_socialize_qq);
            listPlatform.add(model);
        }
    }
    ...
    private void addQzone()
    {
        if (UmengSocialManager.isQQEnable())
        {
            PlatformModel model = new PlatformModel(UmengSocialManager.PLATFORM_QZONE, "QQ空间", R.drawable.umeng_socialize_qzone);
            listPlatform.add(model);
        }
    }
    ...
    private void addSina()
    {
        ...
        {
            PlatformModel model = new PlatformModel(UmengSocialManager.PLATFORM_SINA, "新浪", R.drawable.umeng_socialize_sina);
            listPlatform.add(model);
        }
    }
