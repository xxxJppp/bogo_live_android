...
public class LiveViewerBusiness extends LiveBusiness {
    ...
    public LiveViewerBusiness(ILiveInterface liveActivity) {
        super(liveActivity);
    }
     ...
     * @param
     */
    public void stopLinkhost(String uid) {

        requestStopLianmai("0");


        IMHelper.sendMsgC2C(uid, new CustomMsgStopLinkMic(), null);
    ...
    public interface LiveViewerBusinessCallback extends LiveBusinessCallback {
        ...
        void onBsViewerApplyLinkMicAccepted(CustomMsgAcceptLinkMic msg);
