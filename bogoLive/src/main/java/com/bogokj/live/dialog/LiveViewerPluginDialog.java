...
public class LiveViewerPluginDialog extends SDDialogBase
{
    ...
    private void initView()
    {
        ...
        view_star_store.configImage(view_star_store.iv_image)
                .setImageResIdNormal(R.drawable.selector_plugin_tool_star_store);
        view_star_store.setSelected(false);

        view_shop_store.setTextName("小店");
        view_shop_store.configImage(view_shop_store.iv_image)
                .setImageResIdNormal(R.drawable.selector_plugin_tool_shop_store);
        view_shop_store.setSelected(false);
