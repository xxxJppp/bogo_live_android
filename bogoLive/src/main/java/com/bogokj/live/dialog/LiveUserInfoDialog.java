...
public class LiveUserInfoDialog extends LiveBaseDialog
{
    ...
    private void setBtnFollow(int has_focus)
    {
        if (has_focus == 1)
        {
            ...
            btn_follow.setTextColor(SDResourcesUtil.getColor(R.color.res_text_gray_l));
        } else
        {
            btn_follow.setText("+关注");
            btn_follow.setTextColor(SDResourcesUtil.getColor(R.color.color_9D21FE));
        }
    }
