...
public class PayBalanceTabBaseFragment extends BaseFragment
{
    ...
    private void addTab()
    {
        ...
        tab_left.getViewConfig(tab_left.mTvTitle).setTextColorNormalResId(R.color.res_text_gray_l).setTextColorSelectedResId(R.color.res_main_color);
        tab_left.getViewConfig(tab_left.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT).setBackgroundColorSelectedResId(R.color.res_main_color);

        tab_right.setTextTitle("收费记录");
        tab_right.getViewConfig(tab_right.mTvTitle).setTextColorNormalResId(R.color.res_text_gray_l).setTextColorSelectedResId(R.color.res_main_color);
        tab_right.getViewConfig(tab_right.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT)
                .setBackgroundColorSelectedResId(R.color.res_main_color);
