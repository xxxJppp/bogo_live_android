...
public class RoomLivePayInfoViewerView extends RoomView
{
    ...
    {
        SDViewBinder.setTextView(tv_money, String.valueOf(model.getLive_fee()));
        SDViewBinder.setTextView(tv_time, String.valueOf(model.getTotal_minute()));
    }
    ...
    public void onPayModeCountDown(long leftTime)
    {
        ...
        if (second > 0)
        {
            ...
            tv_pay_info.setText(String.valueOf(second));
        } else
        {
