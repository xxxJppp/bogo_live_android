package com.bogokj.pay.activity;
...
import com.bogokj.pay.fragment.PaySceneBalanceTabFragment;
import com.bogokj.pay.fragment.PayTimeBalanceTabFramgent;
...
public class PayBalanceActivity extends BaseActivity
{
    ...
    {
        tab_pay_time.setTextTitle("按时直播");
        tab_pay_time.getViewConfig(tab_pay_time.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT)
                .setBackgroundColorSelected(SDResourcesUtil.getColor(R.color.res_main_color));
        tab_pay_time.getViewConfig(tab_pay_time.mTvTitle).setTextColorNormal(SDResourcesUtil.getColor(R.color.res_text_title_bar)).setTextColorSelected(SDResourcesUtil.getColor(R.color.res_main_color))
        ...
        tab_pay_scene.setTextTitle("按场直播");
        tab_pay_scene.getViewConfig(tab_pay_scene.mIvUnderline).setBackgroundColorNormal(Color.TRANSPARENT).setBackgroundColorSelected(SDResourcesUtil.getColor(R.color.res_main_color));
        tab_pay_scene.getViewConfig(tab_pay_scene.mTvTitle).setTextColorNormal(SDResourcesUtil.getColor(R.color.res_text_title_bar)).setTextColorSelected(SDResourcesUtil.getColor(R.color.res_main_color))
                .setTextSizeNormal(SDResourcesUtil.getDimensionPixelSize(R.dimen.base_textsize_18)).setTextSizeSelected(SDResourcesUtil.getDimensionPixelSize(R.dimen.base_textsize_18));
