package com.bogokj.dynamic.audiorecord.view;
...
//        rootView.findViewById(R.id.layout_sound_item).setBackgroundDrawable(null);
        ...
        layoutSoundItem = (LinearLayout) findViewById(R.id.layout_sound_item);
        ...
        sound_start = (ImageView) findViewById(R.id.sound_start);
        sound_start.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if (!isPlaying) {
                    playSound();
                    sound_start.setImageResource(R.drawable.sound_pause);
                } else {
                    pauseSound();
                    sound_start.setImageResource(R.drawable.sound_start);
                }
            }
        });
    }
