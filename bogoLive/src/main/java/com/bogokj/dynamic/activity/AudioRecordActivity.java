...
import com.bogokj.dynamic.audiorecord.IRecordAudioListener;
import com.bogokj.dynamic.audiorecord.entity.EnterRecordAudioEntity;
import com.bogokj.dynamic.audiorecord.util.Cons;
import com.bogokj.dynamic.audiorecord.util.PaoPaoTips;
import com.bogokj.dynamic.audiorecord.util.PermissionUtil;
import com.bogokj.dynamic.audiorecord.util.StringUtil;
import com.bogokj.dynamic.audiorecord.view.LineWaveVoiceView;
import com.bogokj.dynamic.audiorecord.view.RecordAudioView;
...
public class AudioRecordActivity extends FragmentActivity implements
    ...
    public String onRecordStart() {
        ...
        audioFileName = App.getApplication().getExternalCacheDir() + File.separator + createAudioName();
