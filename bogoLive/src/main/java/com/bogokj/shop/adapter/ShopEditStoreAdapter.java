...
public class ShopEditStoreAdapter extends SDBaseSwipeAdapter<App_shop_mystoreItemModel>
{
    ...
    public void fillValues(final int position, View v)
    {
        ...
        TextView tv_shop_edit = (TextView) v.findViewById(R.id.tv_shop_edit);//编辑商品
        TextView txv_del = (TextView) v.findViewById(R.id.txv_del);//商品删除
        View view_stroke_line = v.findViewById(R.id.view_stroke_line);

        if (position + 1 == listModel.size())
        {
        ...
        tv_shop_edit.setOnClickListener(new View.OnClickListener()
        {
            @Override
