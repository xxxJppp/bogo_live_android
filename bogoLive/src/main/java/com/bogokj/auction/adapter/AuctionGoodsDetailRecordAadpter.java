...
import com.bogokj.auction.model.PaiUserGoodsDetailDataPaiListItemModel;
...
public class AuctionGoodsDetailRecordAadpter extends SDSimpleAdapter<PaiUserGoodsDetailDataPaiListItemModel>
{
    ...
    public void bindData(int position, View convertView, ViewGroup parent, PaiUserGoodsDetailDataPaiListItemModel model)
    {
        ...
        {
            tv_user_name.setTextColor(SDResourcesUtil.getColor(R.color.res_text_gray_m));
            tv_pai_date.setTextColor(SDResourcesUtil.getColor(R.color.res_text_gray_m));
            tv_pai_diamonds.setTextColor(SDResourcesUtil.getColor(R.color.res_text_gray_m));
            tv_first.setBackgroundResource(R.drawable.auction_layer_white_stroke_corner_3dp);
            tv_first.setTextColor(SDResourcesUtil.getColor(R.color.res_text_gray_m));
            tv_first.setText("出局");
        }
