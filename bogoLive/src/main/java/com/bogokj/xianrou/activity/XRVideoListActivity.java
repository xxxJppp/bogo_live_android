...
import com.bogokj.xianrou.adapter.XRVideoAdapter;
...
public class XRVideoListActivity extends XRBaseTitleActivity
{
    ...
    //    activity.startActivityForResult(new Intent(activity, VideoChooseActivity.class), requestCode);
    }
...
//        long maxDurationSec = Long.valueOf(InitActModelDao.query().getSts_video_limit());
        long maxDurationSec = AppRuntimeWorker.getVideo_max_duration();
