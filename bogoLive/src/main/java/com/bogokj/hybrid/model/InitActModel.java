...
import com.bogokj.live.model.IpInfoModel;
...
public class InitActModel extends BaseActModel {
    ...
    private int is_invite_code;//是否必填邀请码

    private int sdk_type; // 0-腾讯云sdk；1-金山sdk

    private int sts_video_limit;//小视频允许上传的最大秒数

    private String bogo_beauty_key;
    private String agora_app_id;//声网ID

    /*
     * 腾讯云SDK
     * */
    private String tencent_video_sdk_key;
    private String tencent_video_sdk_licence;

    private String tencent_live_sdk_key;
    private String tencent_live_sdk_licence;

    private String service_id;

    //视频分类
    private List<BogoVideoClassLabelModel> video_cate;


    public List<BogoVideoClassLabelModel> getVideo_cate() {
        return video_cate;
    }

    public void setVideo_cate(List<BogoVideoClassLabelModel> video_cate) {
    ...
    public String getTencent_video_sdk_key() {
        return tencent_video_sdk_key;
    }

    public void setTencent_video_sdk_key(String tencent_video_sdk_key) {
        this.tencent_video_sdk_key = tencent_video_sdk_key;
    }

    public String getTencent_video_sdk_licence() {
        return tencent_video_sdk_licence;
    }

    public void setTencent_video_sdk_licence(String tencent_video_sdk_licence) {
        this.tencent_video_sdk_licence = tencent_video_sdk_licence;
    }

    public String getTencent_live_sdk_key() {
        return tencent_live_sdk_key;
    }

    public void setTencent_live_sdk_key(String tencent_live_sdk_key) {
        this.tencent_live_sdk_key = tencent_live_sdk_key;
    }

    public String getTencent_live_sdk_licence() {
        return tencent_live_sdk_licence;
    }

    public void setTencent_live_sdk_licence(String tencent_live_sdk_licence) {
        this.tencent_live_sdk_licence = tencent_live_sdk_licence;
    }
    ...
    public String getBogo_beauty_key() {
        return bogo_beauty_key;
    }

    public void setBogo_beauty_key(String bogo_beauty_key) {
        this.bogo_beauty_key = bogo_beauty_key;
    }

    public int getSts_video_limit() {
        return sts_video_limit;
    }

    public void setSts_video_limit(int sts_video_limit) {
        this.sts_video_limit = sts_video_limit;
    }
    ...
    public int getIs_invite_code() {
        return is_invite_code;
    }

    public void setIs_invite_code(int is_invite_code) {
        this.is_invite_code = is_invite_code;
    }
