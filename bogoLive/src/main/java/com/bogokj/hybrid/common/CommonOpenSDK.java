...
//        }
//
////        int payType = 0;//0代表随机选择 1代表微信支付 2代表支付宝支付
...
////                .setRemark("测试备注");
////        // 主线程中调用 FWPay.pay 方法
////        FWPay.pay(activity, order, payType, listner);
...
//                            //玩家Id(必需)
//                            .setPlayerId(playerId);
//                    String channelType = FWPay.getChannelType(activity,order);
...
//    }
    ...
    //, OnPayResultListener jbfPayResultListener
    public static void dealPayRequestSuccess(App_payActModel actModel, Activity activity, PayResultListner payResultListner)
    {
