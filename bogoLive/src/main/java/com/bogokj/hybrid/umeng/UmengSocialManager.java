...
import com.bogokj.live.dialog.LiveShareDialog;
...
public class UmengSocialManager
{
    ...
    public static void openShare(final String title, final String content, final String imageUrl, final String clickUrl, final Activity activity, final UMShareListener listener)
    {
        ...
        shareDialog.showBottom();
    }

    public static void doShare(int platform, final String title, final String content, final String imageUrl, final String clickUrl, final Activity activity, final UMShareListener listener)
    {
        switch (platform)
        {
            case PLATFORM_WX:
