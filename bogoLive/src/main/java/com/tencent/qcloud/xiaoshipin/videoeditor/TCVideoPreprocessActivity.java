...
public class TCVideoPreprocessActivity extends FragmentActivity implements
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (TextUtils.isEmpty(mInVideoPath)) {
            Toast.makeText(this,
                    getResources().getString(R.string.tc_video_preprocess_activity_an_unknown_error_occurred_the_path_cannot_be_empty),
    ...
    private void initWorkLoadingProgress() {
        if (mWorkProgressFragment == null) {
            mWorkProgressFragment = VideoWorkProgressFragment.newInstance(getResources().getString(R.string.tc_video_preprocess_activity_video_preprocessing));
    ...
    private void cancelProcessVideo() {
        if (!mGenerateSuccess) {
            ...
            TCVideoEditerWrapper.getInstance().clear();
            Toast.makeText(
                    TCVideoPreprocessActivity.this,
                    getResources().getString(R.string.tc_video_preprocess_activity_cancel_preprocessing),
                    Toast.LENGTH_SHORT).show();
            ...
            switch (msg.what) {
                case LOAD_VIDEO_ERROR:
                    DialogUtil.showDialog(activity,
                            App.getApplication().getResources().getString(R.string.tc_video_preprocess_activity_edit_failed),
                            App.getApplication().getResources().getString(R.string.tc_video_preprocess_activity_does_not_support_android_version_below_4_3),
