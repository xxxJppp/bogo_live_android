package com.bogokj.library.webview;
...
import com.bogokj.library.handler.js.BaseJsHandler;
import com.bogokj.library.utils.SDBase64;
import com.bogokj.library.utils.SDIntentUtil;
...
public class CustomWebView extends WebView
{
    ...
    protected void initSettings(WebSettings settings)
    {
        ...
        us = us + " fanwe_app_sdk" + " sdk_type/android" + " sdk_version_name/" + SDPackageUtil.getVersionName() + " sdk_version/" + SDPackageUtil.getVersionCode()  + " screen_width/" + SDViewUtil.getScreenWidth() + " screen_height/" + SDViewUtil.getScreenHeight();
